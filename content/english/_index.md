...
features:
  - title: "My Expertise"
    ...
    bulletpoints:
      - "Over **10** years of experience in technical writing, specializing in [databases](https://docs.pingcap.com/)"
  ...
  - title: "My Side Projects"
    ...
    bulletpoints:
      - "[lilin90/awesome-technical-communication](https://github.com/lilin90/awesome-technical-communication): a GitHub repository containing a curated collection of valuable resources on various aspects of technical communication, with **290+** stars"
      - "[WeChat Subscription Account](https://res.cloudinary.com/lilian-photos/image/upload/v1726561496/cover/wechat-qrcode-scan-to-follow-tcfun.jpg) & [Zhihu column](https://www.zhihu.com/column/tc-fun) 技术传播那些事儿: sharing practical insights on technical communication in Chinese, with **160+** published posts and **6,200+** followers"
    button:
      enable: true
      label: "Check out now"
      link: "https://github.com/lilin90"

  - title: "Me in the Community"
    ...
    bulletpoints:
      - "Presented TiDB Docs as Code practices at [**IEEE ProComm** Conference 2019](https://ieeexplore.ieee.org/document/8804485)"
      - "Presented using ChatGPT in technical communication at **[tcworld China](https://www.tcworld-china.cn/en/)** 2023"
